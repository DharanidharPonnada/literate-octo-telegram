...
if __name__ == "__main__":
    ...
    # Executed inline here to directly capture and unpack token usage metadata metadata
    ...
    # Read response usage metadata to inspect implicit context caching properties
    ...
    if cached_tokens > 0:
        ...
        print(f" 🎉 Success: Context Caching saved {savings_percentage:.1f}% on input processing costs!")
    else:
        print(" 💡 Tip: Running repetitive prompts sequentially utilizes Gemini's implicit context caching optimization.")
